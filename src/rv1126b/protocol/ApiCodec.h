...
public:
    ...
    virtual ApiResult<ClientAckDto> parseClientAck(const QByteArray& payload) const = 0;
    ...
    virtual ApiResult<QByteArray> encodeTriggerModeConfig(const TriggerModeUpdate& update) const = 0;
    virtual ApiResult<QByteArray> encodeLineRegionConfig(const LineRegionUpdate& update) const = 0;
    virtual ApiResult<QByteArray> encodeRuntimeApply(const RuntimeApplyUpdate& update) const = 0;
    ...
    virtual ApiResult<QByteArray> encodeClientAck(const ClientAckCreate& request) const = 0;
};
